#inlcude "../../include/http/HttpServer.h"
...
namespace http
{
    ...
    {
        // 默认http回应函数
        resp->setStatusCode(HttpResponse::404NotFound);
    ...
    void initialize()
    {
        server_.setConnetionCallback(
            std::bind(&HttpServer::onConnetion,this,std::placeholders::_1)
        );

        server_.setMeessageCallback(
